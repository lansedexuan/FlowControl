...
from flow.envs.multiagent import CoTVMixedCustomEnv # CoTVCustomEnv  # CoTVNOCoorCustomEnv  / CoTVAllCustomEnv
...
flow_params = dict(
    ...
    sim=SumoParams(
        ...
        emission_path="{}output/Dub_CoTV_mix".format(ABS_DIR)
    ),
    ...
    env=EnvParams(
        ...
        additional_params={
            ...
            "cav_penetration_rate": CAV_RATE,  # used for CoTVMixedCustomEnv
            "total_veh": 275
        },
    ),
